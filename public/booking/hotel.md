...
[POST] /booking/hotel
```
:eight_spoked_asterisk: [Обсудить документацию, задать вопросы, добавить заявки на улучшения в сам метод бронирования можно здесь](https://github.com/hotels24ua/api-docs/issues/1)
